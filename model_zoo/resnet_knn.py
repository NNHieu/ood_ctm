...
class ResNetCifar(AbstractResNet):
    ...
    def features(self, x, return_feature_list=False):
    ...
    def forward(self, x, fc_params=None, return_feature_list=False):
        features = []
        feat = self.features(x, return_feature_list=return_feature_list)
